...
const uploaderUrl = process.env.BASE_URL + process.env.BASE_LOCALIZATION + '/document/upload';
...
const uploadAndSubmitDocument = async (page: Page, filename: string = 'Atomic_number.pdf') => {
...
const fillInDocumentDetails = async (page: Page, universityName: string = 'Universiteit Leiden', courseName: string = 'Organische Chemie', categoryName: string = 'Lecture notes', academicYear: string = '2020/2021') => {
